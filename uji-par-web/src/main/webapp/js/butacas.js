...
function muestraButacaSeleccionada(butaca) {
	var butacaSeleccionada = $('<img src="../../img/seleccionada.png" class="butaca-seleccionada"/>');
...
function muestraDetallesSeleccionadas() {
	...
	for ( var i = 0; i < butacasSeleccionadas.length; i++) {
		var fila = $('<div class="entrada-seleccionada">'
				+ '<span th:text="#{butacaSeleccionadaLocalizacion}">localización=</span>'
				+ butacasSeleccionadas[i].localizacion
				+ '</span>, '
				+ '<span th:text="#{butacaSeleccionadaFila}">fila=</span>'
				+ butacasSeleccionadas[i].fila
				+ ', '
				+ '<span th:text="#{butacaSeleccionadaNumero}">butaca=</span>'
				+ butacasSeleccionadas[i].numero
				+ ', '
				+ '<span th:text="#{butacaSeleccionadaTipo}">tipo=</span>'
...
function compruebaEstadoButaca(butaca) {
	...
	var path = $("input[name=idSesion]").val() + "/ocupadas";
