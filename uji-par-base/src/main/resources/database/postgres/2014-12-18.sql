...
INSERT INTO PAR_TPVS (ID, NOMBRE, CODE, CURRENCY, TERMINAL, TRANSACTION_CODE, ORDER_PREFIX, LANG_CA_CODE, LANG_ES_CODE, URL, WSDL_URL, DEFAULT_TPV)
              VALUES (0, 'ILUSTRISIMO AYUNTAMIENTO', '055136832', '978', '001', '0', '0000', '003', '001', 'https://sis-t.redsys.es:25443/sis/realizarPago', 'http://wifi.benicassim.es/japps/par-public/services/InotificacionSIS', true);
