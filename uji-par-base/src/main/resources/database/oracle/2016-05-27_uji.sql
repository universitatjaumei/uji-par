...
insert into par_reports("id", sala_id, tipo, clase) values (5, 1, 'pdfTpv', 'es.uji.apps.par.report
.InformeTaquillaTpvSubtotalesReport');
insert into par_reports("id", sala_id, tipo, clase) values (6, 1, 'pdfSGAE', 'es.uji.apps.par.report.InformeEventosReport');
insert into par_reports("id", sala_id, tipo, clase) values (7, 1, 'pdfIncidencias', 'es.uji.apps.par.report
.InformeIncidenciasReport');
